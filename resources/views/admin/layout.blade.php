        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="{{asset('index.html')}}" class="site_title"><i class="fa fa-newspaper-o"></i></i> <span>News Admin</span></a>
            </div>
            ...
            <!-- sidebar menu -->
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> Categories <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="{{asset('addCategory.html')}}">Add Category</a></li>
                ...
                <li><a><i class="fa fa-users"></i> Posts <span class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										...
										<li><a href="{{route('adduser')}}">Add Post</a></li>
									</ul>
								</li>
							</ul>
